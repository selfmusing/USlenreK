...
void ksu_sucompat_init()
{
	...
	pr_info("ksu_sucompat_init: hooks enabled: exevce/execveat_su, faccessat, stat, devpts\n");
}
...
void ksu_sucompat_exit()
{
	...
	pr_info("ksu_sucompat_exit: hooks disabled: exevce/execveat_su, faccessat, stat, devpts\n");
